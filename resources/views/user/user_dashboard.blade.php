@extends('layout')
@section('breadcrumb')
<x-breadcrumb title="User Dashboard" />
@endsection
@section('content')
<div class="content">
                            ...
                            <ul class="nav nav-tabs nav-tabs-bottom nav-justified">
                                <li class="nav-item">
                                    <a class="nav-link active" href="#pat_appointments"
                                        data-toggle="tab">{{ __('Appointments') }}</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#pat_prescriptions" data-toggle="tab">{{ __('Prescriptions') }}</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#pat_medical_records" data-toggle="tab"><span
                                            class="med-records">{{ __('Medical Records') }}</span></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#pat_billing" data-toggle="tab">{{ __('Billing') }}</a>
                                </li>
                            </ul>
                        </nav>
                        <!-- /Tab Menu -->
                                                                    ...
                                                                    <h2 class="table-avatar">
                                                                        <a href="doctor-profile.html"
                                                                            ...
                                                                            <img class="avatar-img rounded-circle"
                                                                                src="{{ $appointment?->doctor?->photo ? asset($appointment?->doctor?->photo) : asset('assets/img/doctors/doctor-thumb-02.jpg') }}"
                                                                                alt="User Image">
                                                                        </a>
                                                                        <a href="doctor-profile.html">{{ $appointment?->doctor?->name }}
                                                                            <span>{{ $appointment?->doctor?->department->name }}</span></a>
                                                                    </h2>
                                                                </td>
                                                                <td>{{ date('d M Y', strtotime($appointment?->appointment_date)) }}<span class="d-block text-info">{{ date('h:i A', strtotime($appointment?->appointment_time)) }}</span>
                                                                </td>
