...
<head>
    ...
    <title>Doccure - @yield('title')</title>
        ...
        <div class="header">
            ...
            <ul class="nav user-menu">
                ...
                <li class="nav-item dropdown has-arrow">
                    <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                        <span class="user-img"><img class="rounded-circle" src="{{ Auth::guard('admin')->user()?->photo == null ? asset('backend/assets/img/profiles/avatar-01.jpg') : asset(Auth::guard('admin')->user()?->photo) }}"
                                width="30" height="30" alt="Ryan Taylor"></span>
                    </a>
                    <div class="dropdown-menu">
                        <div class="user-header">
                            <div class="avatar avatar-sm">
                                <img src="{{ Auth::guard('admin')->user()?->photo == null ? asset('backend/assets/img/profiles/avatar-01.jpg') : asset(Auth::guard('admin')->user()?->photo) }}" alt="User Image"
